...
- **Navigation Bar**  
  Mobile-first design, hamburger menu included.

- **ScrollReveal Animations**  
  Smooth fade/slide-in effects throughout the site.
...
- **About Section**  
  Refined layout, improved imagery, and better text flow.

- **Preloader Animation**  
  Smooth branded loader before page content appears.
...
Clean spacing & minimal composition
...
Fine-tuning spacing between sections

Ensuring consistent typography across breakpoints
...
Using wrapper divs to control animation overflow

Structuring sections cleanly for responsiveness
